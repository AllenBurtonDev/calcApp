...
{
	m_btn1 = new wxButton(this, wxID_ANY, "C", wxPoint(10, 70), wxSize(50, 50));
	m_btn2 = new wxButton(this, wxID_ANY, "MOD", wxPoint(90, 70), wxSize(50, 50));
	m_btn3 = new wxButton(this, wxID_ANY, "BIN", wxPoint(170, 70), wxSize(50, 50));
	m_btn4 = new wxButton(this, wxID_ANY, "HEX", wxPoint(250, 70), wxSize(50, 50));
	...
	m_btn12 = new wxButton(this, wxID_ANY, "*", wxPoint(250, 230), wxSize(50, 50));
